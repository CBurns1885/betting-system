...
try:
    ...
    def step9():
        try:
            ...
            output_path = OUTPUT_DIR / "weekly_bets_full_optimized.csv"
            ...
            if csv_path.exists():
                ...
                raise FileNotFoundError("weekly_bets_full.csv not found")
        except Exception as e:
    ...
    def step10():
        try:
            ...
            input_file = OUTPUT_DIR / "weekly_bets_full.csv"
            output_file = OUTPUT_DIR / "weekly_bets_full_blended.csv"
    ...
    def step16():
        ...
        if csv_path.exists():
            ...
            print("⚠️ weekly_bets_full.csv not found, skipping accuracy tracking")
    
    run_step(16, "UPDATE ACCURACY DATABASE", step16)

    # Step 17: Generate SuperBlends PL Report
    def step17():
        from superblends_pl_report import main as generate_pl_report
        try:
            generate_pl_report()
            print("✅ SuperBlends PL report generated successfully")
        except Exception as e:
            print(f"⚠️ Could not generate PL report: {e}")

    run_step(17, "GENERATE SUPERBLENDS PL REPORT", step17)
    ...
    print("\n📊 Main Files:")
    print("   • weekly_bets_full.csv - All predictions")
